...
- (NSData *)JSONData:(NSString*) src  andDst:(NSString *)dst {
    ...
    json = @{
             ...
             kRTCSessionDescriptionTypeKey : [type uppercaseString],
             kRTCSessionDescriptionDestination : dst,
             kRTCSessionDescriptionPayload : @{kRTCSessionDescriptionTypeKey : type, kRTCSessionDescriptionSdpKey:self.sdp}
             };
